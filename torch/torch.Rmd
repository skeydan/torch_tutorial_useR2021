...
As to `y`, it depends on the number of time steps we want to forecast ahead. Here, we first start with a single step. (We'll adapt this for multi-step prediction later.)
...
#### Exercise part 3: Run training and check
